...
import standardHuffman.* ;
import standardHuffman.Compression;
import standardHuffman.File_handler;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (Map.Entry<Character,Integer> entry : parsed.getFrequencies().entrySet()) {
            System.out.println("key is: "+entry.getKey());
            System.out.println("value is: "+entry.getValue());
        }
        System.out.println(compression.compress(text)) ;
        System.out.println(parsed.getCompressedStream()) ;
    }
}
